...
class SecurityEventsEndpointTest extends WebTestCase
{
    ...
    public function pagination_default_20(): void
    {
        ...
        $this->assertCount(20, $content['hydra:member']); // default itemsPerPage = 20
        $this->assertSame(25, $content['hydra:totalItems']);
        // Check pagination links exist
        $this->assertArrayHasKey('@id', $content['hydra:view']);
        $this->assertArrayHasKey('hydra:next', $content['hydra:view']);
    ...
    public function client_can_set_items_per_page(): void
    {
        ...
        $this->assertSame(10, $content['hydra:totalItems']);
    }
    ...
    public function items_per_page_capped_at_100(): void
    {
        ...
        $content = json_decode($this->client->getResponse()->getContent(), true);
        $this->assertArrayHasKey('hydra:member', $content);
        $this->assertCount(100, $content['hydra:member']); // capped at 100
        $this->assertSame(150, $content['hydra:totalItems']);
    }
}